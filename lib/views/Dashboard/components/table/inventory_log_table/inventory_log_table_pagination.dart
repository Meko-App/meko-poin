...
import 'package:meko_poin/models/inventory_log.dart'; // Updated import

class InventoryLogTablePagination extends StatelessWidget {
  final int currentPage;
  final int totalPages;
  final int startItem;
  final int endItem;
  final List<InventoryLog> data; // Updated type
  final int itemsPerPage;
  final Function(int) onItemsPerPageChanged;
  final Function(int) onPageChanged;

  const InventoryLogTablePagination({
    super.key,
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                '$startItem-$endItem dari ${data.length} log',
                style: const TextStyle(
                  fontSize: 13,
                  color: Color(0xFF4B5675),
                  fontFamily: 'Inter',
